...
int main() {
	...
	if (signal == 0) {
		...
		ConstantGuesser g1010{"1010"}, g6789{"6789"}, g123{"123"};
		...
		.CHECK_EQUAL(play(c123, g12345, 5, 100), 0)     // chooser loses technically by choosing an illegal number (too long).

		.CHECK_EQUAL(play(c123, g1010, 4, 100), 1)      // guesser wins in one turn.
